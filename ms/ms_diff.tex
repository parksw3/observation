...
\providecommand{\DIFaddtex}[1]{{\protect\color{blue}\textbf{#1}}} %DIF PREAMBLE
...
\begin{figure}[!t]
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{../figure/example.pdf}
%DIFDELCMD < %%%
...
\begin{figure}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{../figure/compare_deterministic.pdf}
%DIFDELCMD < %%%
...
at the end of infectious periods \mbox{%DIFAUXCMD
\citep{breto2009time, he2009plug, lin2016seasonality}}\hspace{0pt}%DIFAUXCMD
,
...
\mbox{%DIFAUXCMD
\citep{anderson1980spread}}\hspace{0pt}%DIFAUXCMD
, the stability and persistence of a system
\mbox{%DIFAUXCMD
\citep{keeling1998effect, lloyd2001destabilization, lloyd2001realistic}}\hspace{0pt}%DIFAUXCMD
,
and the  occurrence of dynamical transitions \mbox{%DIFAUXCMD
\citep{krylova2013effects}}\hspace{0pt}%DIFAUXCMD
.
Assumptions about latent and infectious period distributions can also have large effects on the estimates of the basic reproductive number \mbox{%DIFAUXCMD
\citep{wearing2005appropriate}}\hspace{0pt}%DIFAUXCMD
.
}
