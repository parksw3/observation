...
and try to estimate the remaining 4 parameters of the SIR model (Figure 2B), fitting the
incorrect model results in a clearer bias (in opposite directions)
...
We used a deterministic SIR model to show that
assumptions about observation processes can
affect the estimates of the basic reproduction number and their associated confidence intervals.
